...
Another and more robust solution than `sketchy` is the [`rrtools` package](https://github.com/benmarwick/rrtools) described [here](https://annakrystalli.me/rrresearchACCE20/creating-a-research-compendium-with-rrtools.html). This one is especially useful if you are working to publish a big data-driven project, especially something that might be published in book form using [bookdown](https://bookdown.org). 
